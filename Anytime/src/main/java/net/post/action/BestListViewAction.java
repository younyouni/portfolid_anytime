...
public class BestListViewAction implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		//총 리스트 수를 받아옵니다.
		int listcount=postdao.getBestListCount(school_num);
		
		//리스트를 받아옵니다.
		bestlist=postdao.getBestList(school_num, page, limit);
	    ...
	    */
		...
		if(state == null) {
			...
			forward.setPath("post/bestarticle.jsp");
