...
public class HotListViewAction implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		//총 리스트 수를 받아옵니다.
		int listcount=postdao.getHotListCount(school_num);
		//리스트를 받아옵니다.
		hotlist=postdao.getHotList(school_num, page, limit);
	    ...
	    */
		...
		if(state == null) {
			...
			System.out.println(hotlist.get(0).getPost_date());
			...
			forward.setPath("post/hotarticle.jsp");
			...
			JsonElement je=new Gson().toJsonTree(hotlist);
			System.out.println("hotlist="+je.toString());
			object.add("hotlist", je);
