...
<head>
	...
	<script src="/Anytime/js/bestlist.js"></script>
<title>애니타임</title>
<link href="/Anytime/css/post/postlist.css" type="text/css"
	rel="stylesheet">	
<link type="text/css" href="/Anytime/css/best/common.css"
	rel="stylesheet">
<link type="text/css" href="/Anytime/css/best/common.partial.css"
	rel="stylesheet">
<link type="text/css" href="/Anytime/css/best/container.article.css"
	rel="stylesheet">
<link type="text/css" href="/Anytime/css/best/container.community.css"
	rel="stylesheet">
<link type="text/css" href="/Anytime/css/best/container.modal.css"
	rel="stylesheet">
</head>
<link href="/Anytime/css/common.css" type="text/css" rel="stylesheet">
<link href="/Anytime/css/post/boardlist.css" type="text/css"
	rel="stylesheet">
<link href="/Anytime/css/common.partial.css" type="text/css"
	rel="stylesheet">
<link href="/Anytime/css/container.article.css" type="text/css"
	rel="stylesheet">
<link href="/Anytime/css/container.community.css" type="text/css"
	rel="stylesheet">
<link href="/Anytime/css/container.modal.css" type="text/css"
	rel="stylesheet">
<body style="">
	...
	<div id="container" class="article">
		<input type="hidden" id="isUser" value="1"> <input
			type="hidden" id="boardId" value="bestarticle">
		<aside class="none">
			<div class="title">
				<a class="hamburger"></a>
				<h1>
					<a href="BestListView.bo">BEST 게시판</a>
				</h1>
			</div>
		</aside>
		...
		<div class="wrap seasons">
			<div class="season selected">
				<span>23년 하반기</span>
			</div>
			<div class="season">
				<span>23년 상반기</span>
		...
		<c:forEach var="post" items="${bestlist}">
			<article>
				<a class="article" href="PostDetailAction.bo?post_num=${post.post_num}"><img
					src="https://cf-fpi.everytime.kr/0.png" class="picture medium">
					<h3 class="medium">${post.nickname}</h3> <time class="medium">${post.post_date}</time>
					<hr>
				...
				<ul class="status" style="padding-right:15px; padding-bottom:10px;">
					...
					<hr> <input type="hidden" name="310144057_comment_anonym"
					value="0"></a>
			...
			<div class="pagination">
				<a href="/bestarticle/p/2" class="next">다음</a>
			</div>
		--%>
            ...
            <ul class="pagination justify-content-center">
               ...
               <c:if test="${page > 1 }">
                  <li class="page-item"><a href="BestListView.bo?page=${page-1}"
               ...
               <c:forEach var="a" begin="${startpage}" end="${endpage}">
                  ...
                  <c:if test="${a != page }">
                     <li class="page-item"><a href="BestListView.bo?page=${a}"
